...
@section('content')
    <div class="cgu">  
        ...
        <p style="text-align:justify"><strong> Modification des conditions d’utilisation : </strong> <br />
                ...
                L’utilisateur reconnaît que les données circulant sur Internet ne sont pas protégées notamment contre les détournements éventuels. La présence du logo BDE CESI Bordeaux institue une présomption simple de validité. La communication de toute information jugée par l’utilisateur de nature sensible ou confidentielle se fait à ses risques et périls.
        ...
        <p style="text-align:justify"><strong> Droit applicable : </strong> <br />
                ...
                Pour toute question relative aux présentes conditions d’utilisation du site, vous pouvez nous écrire à l’adresse suivante : communication@bdecesibordeaux.fr</p>
